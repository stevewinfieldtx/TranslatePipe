...
export default function Home() {
      ...
      ws.onmessage = (event) => {
        ...
        if (msg.message === 'RecognitionStarted') {
          ...
          proc.onaudioprocess = (e) => {
            ...
            copy.set(d);
            ws.send(copy.buffer);
            if (++n % 100 === 0) console.log('[AUDIO] ' + n + ' chunks');
          };
  ...
  return (
    <div style={S.page}>
      ...
      <p style={S.sub}>English &rarr; Chinese</p>
      <div style={S.box}>
        ...
        <div style={S.feed}>
          ...
          {entries.length === 0 && !partial && <p style={S.ph}>Speak English — hear Chinese</p>}
          {entries.map((e, i) => (
            <div key={i}>
